...
public class MyTestController {
    ...
    @RequestMapping("sql/master")
    public Object testSql(String sql) {
        return mapper.testSQL(sql);
    }
    @DS("slave_1")
    @RequestMapping("sql/slave_1")
    public Object testSql1(String sql) {
        return mapper.testSQL(sql);
    }
    @DS("slave_2")
    @RequestMapping("sql/slave_2")
    public Object testSql2(String sql) {
        return mapper.testSQL(sql);
    }
